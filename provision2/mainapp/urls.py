...
urlpatterns = [
    ...
    path('calcola_prefattura/<int:pk>/',calcola_prefattura, name="calcola_prefattura"),
    path('genera-pdf-prefattura/<int:pk>/',genera_pdf_prefattura, name='genera_pdf_prefattura'),
